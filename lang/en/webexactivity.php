...
$string['errordownloadingrecording'] = 'Error while downloading recording';
...
$string['event_recording_made_internal'] = 'Recording made internal';
$string['event_recording_remote_deleted'] = 'Recording deleted from Webex server';
