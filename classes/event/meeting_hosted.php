 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class meeting_hosted extends \core\event\content_viewed {
    ...
    public function get_description() {
        return 'User with id ' . $this->userid . ' hosted webex meeting with id ' . $this->objectid;
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'webexactivity', 'meeting hosted', 'view.php?id=' . $this->context->instanceid, $this->objectid,
    ...
    public static function get_name() {
        return get_string('event_meeting_hosted', 'webexactivity');
    }
