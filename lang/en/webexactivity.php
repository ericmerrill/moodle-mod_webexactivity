...
$string['userexistsexplanation'] = '<div>You email address ({$a->email}) is already in user by the WebEx User <b>{$a->username}</b>. Please enter your WebEx password below.</div>';
